...
- Krom points to taxonomy term 4691, renders that View's actual result, and keeps
  the logo animation.
...
The deployable result is `artifacts/dwars2026-theme.tar.gz`. The archive contains
